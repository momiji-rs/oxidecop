...
COPS="Style/NilComparison,Style/NumericPredicate,Style/ZeroLengthPredicate,Style/RedundantReturn,Style/NumericLiterals,Style/StringLiterals,Style/Documentation,Style/FrozenStringLiteralComment,Style/SymbolProc,Naming/MethodName,Lint/NestedMethodDefinition,Layout/LineLength,Layout/TrailingWhitespace,Style/EvenOdd,Lint/RandOne,Style/ArrayJoin,Lint/BooleanSymbol,Lint/BigDecimalNew,Style/Dir,Style/StringChars,Style/NestedFileDirname,Lint/UriRegexp,Lint/EmptyEnsure,Lint/EmptyExpression,Lint/UriEscapeUnescape,Style/UnpackFirst,Style/RandomWithOffset,Lint/Debugger,Style/NegatedIf,Lint/EmptyFile,Layout/TrailingEmptyLines,Layout/InitialIndentation,Style/NegatedWhile,Style/CharacterLiteral,Style/UnlessElse,Lint/EmptyInterpolation,Lint/EnsureReturn,Style/EndBlock,Style/BeginBlock,Naming/ConstantName,Naming/ClassAndModuleCamelCase,Naming/BinaryOperatorParameterName,Lint/DuplicateRequire,Style/StderrPuts,Style/WhileUntilDo,Style/MultilineIfThen,Style/Not,Style/ColonMethodCall,Lint/EmptyClass,Lint/DeprecatedClassMethods,Layout/EmptyLineAfterMagicComment,Layout/EmptyLines,Style/EmptyLiteral,Style/Semicolon,Style/GlobalVars,Layout/SpaceAfterComma,Style/DefWithParentheses"
